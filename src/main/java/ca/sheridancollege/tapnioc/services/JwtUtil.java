...
public class JwtUtil {
	...
	private String SECRET_KEY = "this is a secret, should be original, and of a decent length!";
	...
	// cryptographically securely parse all claims from a JWT token based on our
	// secret key
